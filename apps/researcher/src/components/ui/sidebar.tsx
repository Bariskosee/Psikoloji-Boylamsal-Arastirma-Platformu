...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        // `min-w-0` added to the upstream classes, deliberately.
        //
        // A flex item defaults to `min-width: auto`, which means it refuses to
        // shrink below its content. A wide data table inside therefore pushed
        // this panel past the viewport and the WHOLE PAGE scrolled sideways —
        // taking the sidebar and the sticky header with it — instead of the
